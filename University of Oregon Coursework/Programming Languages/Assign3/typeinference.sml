...
(* The term datatype without typed function arguments *)
...
fun W (E, Literal n)   = (identity, INT)
  ...
  | W (E, Variable x) = raise Unimplemented
  | W (E, Plus (e1, e2)) = raise Unimplemented
  | W (E, Lambda (x, e)) = raise Unimplemented
  | W (E, Lett (x, e1, e2)) = raise Unimplemented
  | W (E, App (e1, e2)) = raise Unimplemented
  | W (E, Rec (x, e)) = raise Unimplemented
  | W (E, Bool b) = raise Unimplemented
  | W (E, IsZero e) = raise Unimplemented
